...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <small><h4>Registro de psicologo</h4></small>
            </h1>
        </section>
        <!-- Main content -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="register-box-body" style="width: 50%; margin: auto">
                        <p class="login-box-msg">Ingresa los datos del nuevo psicologo</p>
                        <form>
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" id="passP" placeholder="Contraseña" minlength="6" maxlength="10" required="">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" id="verPassP" placeholder="Repetir contraseña" minlength="6" maxlength="10" required="">
                            </div>
                            <div class="form-group">
